...
public class Game extends Canvas {
    	...
    	private void initEntities() {
              ...
              ship = new ShipEntity(this, "sprites/ship.gif", 0, 950);
              entities.add(ship);
         ...
         */
         ...
         public void notifyWin(){
           message = "You restored balance to the world!";
           waitingForKeyPress = true;
         } // notifyWin
        ...
        public void tryToBomb() {
            ...
            // otherwise add a shot
            lastFire = System.currentTimeMillis();
            BombEntity bomb = new BombEntity(this, "sprites/bomb.gif", 
                              ship.getX() + 10, ship.getY() - 30);
            entities.add(bomb);
        }//tryToBomb
        
        public void bombExplode(Entity a) {
        	ShotEntity shot = new ShotEntity(this, "sprites/bombShot.gif", 
                    a.getX() - 50, a.getY() + 10);
        	entities.add(shot);
        	shot = new ShotEntity(this, "sprites/bombShot.gif", 
                    a.getX() + 50, a.getY() + 10);
        	entities.add(shot);
        	shot = new ShotEntity(this, "sprites/bombShot.gif", 
                    a.getX() - 50, a.getY() - 40);
	...
	public void gameLoop() {
          ...
          while (gameRunning) {
           ...
           if (waitingForKeyPress) {
             ...
             g.drawString("Only the Avatar Can Save the World", 
            		(800 - g.getFontMetrics().stringWidth
            		("Only the Avatar Can Save the World"))/2, 300);
           }  // if
